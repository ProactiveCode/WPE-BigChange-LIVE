 ...
 */
?>
<?php if(get_field('ptt_blue_bg')) { echo '<div class="bg-light-blue">'; } ?>
<div class="container padded-top-bot margin-btm-20">
    <div class="ptt-tool">
        <div class="ptt-tool__left">
            <?php $lefts = get_field('pttool_left_items');
        ...
        <div class="ptt-tool__center">
            <div class="ptt-tool__title">
                <?php if(get_field('pttool_main_title_h')) {
                    $h = get_field('pttool_main_title_h');
                    echo '<h' . $h . '>' . get_field('pttool_main_title') . '</h' . $h . '>';
                } else { ?>
                    <h3><?php echo get_field('pttool_main_title'); ?></h3>
                <?php } ?>
            </div>
            <div class="ptt-tool__text">
                <p><?php echo get_field('pttool_main_text'); ?></p>
            </div>
            <div class="ptt-tool__image" data-original-image="<?php echo get_field('main_image')['url']; ?>">
                <img src="<?php echo get_field('main_image')['url']; ?>" alt="<?php echo get_field('main_image')['alt']; ?>">
            </div>
        ...
        <div class="ptt-tool__right">
            <?php $rights = get_field('pttool_right_items');
...
<?php if(get_field('ptt_blue_bg')) { echo '</div>'; } ?>