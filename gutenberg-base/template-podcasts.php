...
<main class="main blog blog--podcast" role="main" id="main-content">
<?php $heros = get_field('hero');
		if($heros) { 
			...
			<div class="hero <?php if(get_the_ID() == 1277) { echo 'hero--no-mobile'; } ?>">
				...
				<?php } ?>
				<div class="hero__wrapper <?php if($heroCount > 1) { echo 'owl-carousel'; } ?><?php if(isset($hero['drop_padding'])) { echo ' hero__drop-btm-pad'; } ?>">
    ...
    <div class="section container">
        <div class="blog__text blog__text--podcast wysiwyg">
            <?php echo the_content(); ?>
        </div>
		<div class="blog--podcast-ctas">
			<a class="btn-normal rss" target="_blank" href="https://feeds.captivate.fm/growth-stories-with-martin-port/">RSS Feed</a>
			<a class="btn-normal spotify" target="_blank" href="https://open.spotify.com/show/1GM6WOvkxhYTq9U4raqYHM?si=6421b1de0ae54cff">Spotify</a>
			<a class="btn-normal amazon" target="_blank" href="https://music.amazon.co.uk/podcasts/10e0a390-b070-4c1a-b755-b234bdb10433/growth-stories-with-martin-port">Amazon Music</a>
			<a class="btn-normal apple" target="_blank" href="https://podcasts.apple.com/gb/podcast/growth-stories-with-martin-port/id1633098826">Apple Podcasts</a>
		</div>
        <div class="blog__wrapper blog__wrapper--podcast">
            <div class="blog__results blog__results--podcast">
    
            </div>
            <div class="blog__loader blog__loader--podcast">
                <div class="loader"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>
            </div>
        </div>
        
        <div class="blog__load-more--podcast hidden">
