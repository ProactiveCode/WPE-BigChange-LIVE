		...
		<div class="landing-page__wrapper">
			<div class="container">
				...
				<div class="landing-page__menu">
					<div class="landing-page__menu-wrapper">
						<ul>
							<?php $links = get_field('landing_page_menu');
							foreach ($links as $link) { ?>
								<li <?php if($link['blue_styling']) { echo 'class="landing-page__menu-blue"'; } ?>><a href="<?php echo $link['link']; ?>"><?php echo $link['link_text']; ?></a></li>
							<?php } ?>	
						</ul>
					</div>
				</div>
