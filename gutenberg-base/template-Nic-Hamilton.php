<?php
/**
* Template Name: Nic Hamilton Page
*/
...
get_header(); ?>
	...
	<main id="primary" class="site-main ppc">
							...
							<?php if($hero['none_home_foreground']) { ?>
								...
								<div class="hero__ppc-form-text">
									...
									hbspt.forms.create({
										region: "na1",
										portalId: "20046553",
										formId: "cea994b4-4bc7-4d6f-be37-9a64262bcb17",
										onFormSubmit: function($form) { console.log('Nic Hamilton submit'); fbq('track', 'AddToWishlist'); window.lintrk('track', { conversion_id: 5720010 }); twq('track', 'AddToWishlist');}
									});
									</script>
									</div>
								</div>
		...
		while ( have_posts() ) : the_post();
			echo '<div class="section container nic-hamilton">';						
