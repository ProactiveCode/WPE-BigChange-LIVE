<?php
/**
* Template Name: PPC Capterra
*/


get_header('ppc'); ?>

	<main id="primary" class="site-main capterra">
		...
		<!-- <div class="floating-form container" style="display:none;">
			<div class="floating-form__wrapper">
				...
				<?php //echo do_shortcode('[contact-form-7 id="22920" title="Landing Page Form - Capterra" html_id="capterra-landing-page-form"]'); ?>
			</div>
		</div> -->
